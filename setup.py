...
requirements = [
    "Pillow>=9.4.0",
    "mss>=6.1.0",
    "ultralytics==8.0.20",  # Pinned compatible version
    "screeninfo>=0.8.1",
    "numpy>=1.24.3",
    "requests>=2.25.1"
]
...
setup(
    ...
    url="https://github.com/wuhplaptop/yolo_overlay",
    packages=find_packages(include=["yolo_overlay", "yolo_overlay.*"]),
    package_data={
        'yolo_overlay': ['resources/*.dll', 'resources/*.pt'],  # Includes DLL and model files
    },
